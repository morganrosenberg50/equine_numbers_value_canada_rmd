...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = "Figure 1: A historical plotting of horse populations per province in Canada from 1906-1972", out.width='100%'}
...
```{r max horse table, fig.cap = "Table 1: Min/max horse populations per province from 1940 -1972", out.width='100%'}
...
Below we zoom in and look at the province detailed in the parameter set when running this report (default province: Alberta)

```{r plot province, fig.width=5, fig.height=4, fig.cap = "Figure 2: Analysis of params$province horse population from 1940 - 1972", out.width='100%'}
